...
<?php endif; ?>
	...
	<?php if ( is_home() ) : ?>
		...
		<header class="page-header text-light text-center d-flex justify-content-center align-items-center py-5 bg-lt-blue">
			<?php
				echo '<h1 class="page-title mb-0">Firm News</h1>';
			?>
		</header><!-- .page-header -->
