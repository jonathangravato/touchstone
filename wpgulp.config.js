...
module.exports = {
	...
	// Project options.
	projectURL: 'touchstone.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'wp-bootstrap-4', // Your textdomain here.
	translationFile: 'wp-bootstrap-4.pot', // Name of the translation file.
